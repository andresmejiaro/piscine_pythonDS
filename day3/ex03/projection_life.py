...
data=pd.read_csv("/home/andres/pythonfds/day3/ex03/income_per_person_gdppercapita_ppp_inflation_adjusted.csv")

#%%
data=data.melt(id_vars=["country"], var_name = "Year", value_name="life expectancy")
